...
Functionality: **_Different options for splitting a body with XML content_**
...
git clone https://github.com/jammazwan/xaf_SplitXML.git
cd jammazwan.shared
mvn install 
```
...
_run XafTest to explore the options. NOTES.md is the actual doc on this project._
...
so you can focus only on what is required to demo the **SplitXML** feature **_in isolation_**.
...
The prefix **xaf** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
